...
namespace Assignment8.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(AssignmentDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publishers != null ? 
                          ...
                          Problem("Entity set 'AssignmentDbContext.Publishers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AssignmentDbContext.Publishers'  is null.");
            }
            var publisher = await _context.Publishers.FindAsync(id);
            if (publisher != null)
            {
