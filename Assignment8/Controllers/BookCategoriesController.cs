...
namespace Assignment8.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public BookCategoriesController(AssignmentDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BookCategories != null ? 
                          ...
                          Problem("Entity set 'AssignmentDbContext.BookCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AssignmentDbContext.BookCategories'  is null.");
            }
            var bookCategory = await _context.BookCategories.FindAsync(id);
            if (bookCategory != null)
            {
